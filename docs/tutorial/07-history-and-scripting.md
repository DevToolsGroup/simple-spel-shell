...
— specifically, what you typed *before* shorthand rewriting,
...
```shell
mvn test-compile exec:java -Dexec.classpathScope=test -Dexec.mainClass=org.devtoolsgroup.tutorial.example5.TaskShell
```
...
```shell
mvn test-compile exec:java -Dexec.classpathScope=test -Dexec.mainClass=org.devtoolsgroup.tutorial.example6.TaskShell
```
