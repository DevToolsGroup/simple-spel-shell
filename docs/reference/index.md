...
| `hist` / `exprHistoryFile` | Expression history logging | [ReplConfig](repl-config.md), [ShellUtils](shell-utils.md) | [7](../tutorial/07-history-and-scripting.md) |
...
| `ShellException` |  | [Exceptions](exceptions.md) | [10](../tutorial/10-error-handling.md) |
